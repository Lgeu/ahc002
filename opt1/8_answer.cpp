...
constexpr double ANNEALING_A = -3.092636964555644;  // OPTIMIZE [-10.0, 0.0]
constexpr double ANNEALING_B = 6.358852969457378;  // OPTIMIZE [0.0, 7.0]
constexpr double ANNEALING_END = 0.0030958772051163136;  // OPTIMIZE [1e-4, 0.005] LOG
constexpr double ANNEALING_START = 0.3054787241864302;  // OPTIMIZE [0.001, 0.5] LOG
constexpr double GRADIENT_CLIPPING = 4.7724326404306015e-05;  // OPTIMIZE [1e-7, 2e-4] LOG
constexpr double GRADIENT_DESCENT_LR = 30001110.763863176;  // OPTIMIZE [100000.0, 50000000.0] LOG
constexpr double GRADIENT_DESCENT_MOMENTUM = 0.05028569189705678;  // OPTIMIZE [0.0, 1.0]
constexpr int GRADIENT_DESCENT_STEPS = 5;  // OPTIMIZE [1, 30]
constexpr double GRADIENT_DESCENT_STEPS_STEPPING_PROGRESS_RATE = 0.016121758710028855;  // OPTIMIZE [0.0, 1.0]
constexpr double LINE_LENGTH_LOSS_STEPPING_PROGRESS_RATE = 0.49908766525060266;  // OPTIMIZE [0.0, 1.0]
constexpr double  LINE_LENGTH_LOSS_WEIGHT = 7.297578672612888e-05;  // OPTIMIZE [1e-8, 1e-4] LOG
