...
struct State {
	...
	inline double calc_score_cumulative() {
		...
		constexpr double COEF_CENTER_L1 = -25.47314433659313;  // OPTIMIZE [-100.0, 100.0]
		constexpr double COEF_CENTER_L1_SQ = 1.9041247129555376;  // OPTIMIZE [0.0, 100.0]
		constexpr double COEF_POINT = 25.003809660844215;  // OPTIMIZE [0.0, 100.0]
	...
	inline double calc_score(
		...
		constexpr double COEF_DIST = 9569.291875048872;  // OPTIMIZE [0.0, 10000.0]
