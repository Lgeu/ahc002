...
struct State {
	...
	inline double calc_score_cumulative() {
		...
		constexpr double COEF_CENTER_L1 = -23.148245723446557;  // OPTIMIZE [-100.0, 100.0]
		constexpr double COEF_CENTER_L1_SQ = 10.461098486931428;  // OPTIMIZE [0.0, 100.0]
		constexpr double COEF_POINT = 26.181183860113418;  // OPTIMIZE [0.0, 100.0]
	...
	inline double calc_score(
		...
		constexpr double COEF_DIST = 8852.246243824698;  // OPTIMIZE [0.0, 10000.0]
		return ((Vec2<double>)(start - end)).l2_norm_square() * COEF_DIST;
	}
