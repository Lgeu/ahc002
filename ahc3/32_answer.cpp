...
struct State {
	...
	inline double calc_score_cumulative() {
		...
		constexpr double COEF_CENTER_L1 = 37004.57201587735;  // OPTIMIZE [-100.0, 100.0]
		constexpr double COEF_CENTER_L1_SQ = 0.32092144803301226;  // OPTIMIZE [0.0, 200.0]
		constexpr double COEF_POINT = 95.99867651499586;  // OPTIMIZE [0.0, 100.0]
	...
	inline double calc_score(
		...
		constexpr double COEF_DIST = 180.15663550698724;  // OPTIMIZE [0.0, 10000.0]
		constexpr double COEF_TWIST = 711329.833896799;  // OPTIMIZE [0.0, 1000000.0]
		double res = 0;
