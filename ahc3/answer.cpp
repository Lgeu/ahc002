...
struct State {
	...
	inline double calc_score_cumulative() {
		...
		constexpr double COEF_CENTER_L1 = 10.0;  // OPTIMIZE [-100.0, 100.0]
		constexpr double COEF_CENTER_L1_SQ = 100.0;  // OPTIMIZE [0.0, 200.0]
		constexpr double COEF_POINT = 10.0;  // OPTIMIZE [0.0, 100.0]
	...
	inline double calc_score(
		...
		constexpr double COEF_DIST = 100.0;  // OPTIMIZE [0.0, 10000.0]
		constexpr double COEF_TWIST = 1000000.0;  // OPTIMIZE [0.0, 1000000.0]
		double res = 0;
